...
public class TUICamera : MonoBehaviour
{
	...
	private void GetScreenInfo(out float width, out float height, out bool hd)
	{
		...
		//	hd = false;
		//}
		//else if (UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPhone4 || UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPhone4S || UnityEngine.iOS.Device.generation == UnityEngine.iOS.DeviceGeneration.iPodTouch4Gen)
		//{
		//	width = 960f;
		//	height = 640f;
		//	hd = true;
		//}
		//else if (Mathf.Min(Screen.width, Screen.height) < 641)
		//{
		//	width = 1136f;
		//	height = 640f;
		//	hd = true;
